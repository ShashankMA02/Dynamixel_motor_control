...
# Goal positions
GOAL_POSITION_2560 = 2387           # Goal position for motors 1, 3, 5
GOAL_POSITION_1536 = 1710           # Goal position for motors 2, 4, 6
...
def main():
    ...
    while True:
        ...
        for dxl_id in DXL_IDS:
            ...
            # Check if motor is within tolerance to goal position
    ...
    # Disable torque for all motors after reaching goal positions
    for dxl_id in DXL_IDS:
